...
Na tej podstawie wszystkie kryteria połączono w jeden framework M1--M6.
...
\midrule
\endhead
M1 & Integralność i niezależność danych & Czy próbki, etykiety i podziały są
poprawne i niezależne? & Braki, duplikaty, konflikty etykiet, przecieki
train--test oraz udokumentowanie pochodzenia danych. \\
M2 & Pokrycie zjawiska i błędów & Czy istotne warianty zjawiska są obecne,
...
M3 & Pokrycie i stabilność reprezentacji & Czy dane obejmują różnorodność widoczną
...
M4 & Stabilność decyzji i wniosków & Czy wynik utrzymuje się po zmianie próby,
seeda lub progu? & Bootstrapowe przedziały ufności, wiele seedów, sweep
progów i test przesunięcia rozkładu. \\
M5 & Równość jakości i budżetu obliczeń & Czy część danych nie jest systematycznie
gorzej obsługiwana? & Trafność, kalibracja, dodatkowe błędy, decyzje wyjścia
i koszt per klasa lub per region danych. \\
M6 & Adekwatność wdrożeniowa i odporność techniczna & Czy dane i model
...
Markery dotyczą specyfiki zjawiska, nie tylko ogólnego próbkowania. M2 ocenia
odmiany obrazu istotne dla rozpoznawania, M3 ujawnia luki widoczne dla modelu,
a M5 łączy dane wejściowe z jakością i kosztem działania systemu.
...
M1 może blokować wniosek mimo dobrych pozostałych miar. Ograniczony M6 nie
...
\midrule
M1 & W CIFAR-10 nie wykryto dokładnego nakładania train--test. W lokalnej
...
M4 & Udział małych bramek silnie zależał od progu; fragile ratio osiągał
99,9--100\%. & Małe wartości bramek nie są stabilnym dowodem rzeczywistej
redukcji kosztu. \\
M4/M5 & W trzech seedach adaptacyjne wyjście zmieniło średnią trafność o
...
M5 & Prefix-forward dla batch size 1 wskazał około 14,6\% krótszą oczekiwaną
...
M6 & CIFAR i Tiny ImageNet są małymi benchmarkami. & Umożliwiają porównanie
...
\begin{enumerate}
 ...
 \item wygenerować kartę zakresu stosowalności według M1--M6.
\end{enumerate}
