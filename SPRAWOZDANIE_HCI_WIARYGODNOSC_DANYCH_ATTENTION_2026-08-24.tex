...
Pokrycie zjawiska i błędów & Czy istotne warianty zjawiska są obecne,
...
Pokrycie i stabilność reprezentacji & Czy dane obejmują różnorodność widoczną
...
Markery dotyczą specyfiki zjawiska, nie tylko ogólnego próbkowania. Marker pokrycia zjawiska i błędów ocenia
odmiany obrazu istotne dla rozpoznawania, marker reprezentacji ujawnia luki widoczne dla modelu,
a marker równości jakości i budżetu łączy dane wejściowe z jakością i kosztem działania systemu.
...
może blokować wniosek mimo dobrych pozostałych miar. Ograniczona adekwatność wdrożeniowa nie
...
Stabilność decyzji i wniosków & Udział małych bramek silnie zależał od progu; fragile ratio osiągał
99,9--100\%. & Małe wartości bramek nie są stabilnym dowodem rzeczywistej
redukcji kosztu. \\
Stabilność wniosków oraz równość jakości i budżetu & W trzech seedach adaptacyjne wyjście zmieniło średnią trafność o
...
Równość jakości i budżetu obliczeń & Prefix-forward dla batch size 1 wskazał około 14,6\% krótszą oczekiwaną
...
Adekwatność wdrożeniowa i odporność techniczna & CIFAR i Tiny ImageNet są małymi benchmarkami. & Umożliwiają porównanie
