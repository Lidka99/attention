"""Held-out predictability of oracle actions from features after ResNet layer1."""
...
def main():
    ...
    head = nn.Sequential(nn.Linear(256, 64), nn.ReLU(), nn.Linear(64, 13)).cpu()
    ...
    report = {"feature_source": "layer1", "samples_per_split": args.samples, "steps": args.steps,
              "majority_action": majority_label, "train": evaluate(head, train, majority_label),
              "validation": evaluate(head, validation, majority_label)}
